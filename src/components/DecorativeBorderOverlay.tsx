      ...
      case 'art-deco':
        return (
          <svg style={svgStyle} viewBox="0 0 100 150" preserveAspectRatio="none">
            ...
            {/* Top Left */}
            <path d="M0 0 L25 0 L25 3 L3 3 L3 25 L0 25 Z" fill={fillColor} opacity="0.3" />
            <path d="M0 0 L15 0 L0 15 Z" fill={fillColor} opacity="0.5" />
            <path d="M5 0 L0 5" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M10 0 L0 10" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="8" cy="8" r="2" fill="none" stroke={strokeColor} strokeWidth="1" />
            
            {/* Top Right */}
            <path d="M100 0 L75 0 L75 3 L97 3 L97 25 L100 25 Z" fill={fillColor} opacity="0.3" />
            <path d="M100 0 L85 0 L100 15 Z" fill={fillColor} opacity="0.5" />
            <path d="M95 0 L100 5" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M90 0 L100 10" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="92" cy="8" r="2" fill="none" stroke={strokeColor} strokeWidth="1" />
            
            {/* Bottom Left */}
            <path d="M0 150 L25 150 L25 147 L3 147 L3 125 L0 125 Z" fill={fillColor} opacity="0.3" />
            <path d="M0 150 L15 150 L0 135 Z" fill={fillColor} opacity="0.5" />
            <path d="M5 150 L0 145" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M10 150 L0 140" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="8" cy="142" r="2" fill="none" stroke={strokeColor} strokeWidth="1" />
            
            {/* Bottom Right */}
            <path d="M100 150 L75 150 L75 147 L97 147 L97 125 L100 125 Z" fill={fillColor} opacity="0.3" />
            <path d="M100 150 L85 150 L100 135 Z" fill={fillColor} opacity="0.5" />
            <path d="M95 150 L100 145" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M90 150 L100 140" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="92" cy="142" r="2" fill="none" stroke={strokeColor} strokeWidth="1" />
            
            {/* Center sunburst top */}
            <path d="M50 0 L47 8 L50 6 L53 8 Z" fill={fillColor} />
            <path d="M45 0 L46 5" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M55 0 L54 5" stroke={strokeColor} strokeWidth="0.5" />
            
            {/* Center sunburst bottom */}
            <path d="M50 150 L47 142 L50 144 L53 142 Z" fill={fillColor} />
            <path d="M45 150 L46 145" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M55 150 L54 145" stroke={strokeColor} strokeWidth="0.5" />
          </svg>
        );
      ...
      case 'celtic-knot':
        return (
          <svg style={svgStyle} viewBox="0 0 100 150" preserveAspectRatio="none">
            ...
            {/* Connecting lines */}
            <path d="M20 5 L80 5" stroke={strokeColor} strokeWidth="0.5" strokeDasharray="2,2" />
            <path d="M20 145 L80 145" stroke={strokeColor} strokeWidth="0.5" strokeDasharray="2,2" />
            <path d="M5 20 L5 130" stroke={strokeColor} strokeWidth="0.5" strokeDasharray="2,2" />
            <path d="M95 20 L95 130" stroke={strokeColor} strokeWidth="0.5" strokeDasharray="2,2" />
          </svg>
        );
      ...
      case 'victorian':
        return (
          <svg style={svgStyle} viewBox="0 0 100 150" preserveAspectRatio="none">
            ...
            <rect x="4" y="6" width="92" height="138" fill="none" stroke={strokeColor} strokeWidth="0.8" rx="2" />
            
            {/* Top center medallion */}
            <ellipse cx="50" cy="6" rx="12" ry="4" fill="none" stroke={strokeColor} strokeWidth="0.8" />
            <path d="M42 6 Q50 2 58 6" fill="none" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M46 6 L50 3 L54 6" fill={fillColor} opacity="0.5" />
            
            {/* Bottom center medallion */}
            <ellipse cx="50" cy="144" rx="12" ry="4" fill="none" stroke={strokeColor} strokeWidth="0.8" />
            <path d="M42 144 Q50 148 58 144" fill="none" stroke={strokeColor} strokeWidth="0.5" />
            <path d="M46 144 L50 147 L54 144" fill={fillColor} opacity="0.5" />
            
            {/* Corner scrollwork */}
            {/* Top Left */}
            <path d="M4 20 Q0 15 4 10 Q8 5 15 6" fill="none" stroke={strokeColor} strokeWidth="0.8" />
            <path d="M8 6 Q4 10 8 14" fill="none" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="10" cy="10" r="1.5" fill={fillColor} />
            
            {/* Top Right */}
            <path d="M96 20 Q100 15 96 10 Q92 5 85 6" fill="none" stroke={strokeColor} strokeWidth="0.8" />
            <path d="M92 6 Q96 10 92 14" fill="none" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="90" cy="10" r="1.5" fill={fillColor} />
            
            {/* Bottom Left */}
            <path d="M4 130 Q0 135 4 140 Q8 145 15 144" fill="none" stroke={strokeColor} strokeWidth="0.8" />
            <path d="M8 144 Q4 140 8 136" fill="none" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="10" cy="140" r="1.5" fill={fillColor} />
            
            {/* Bottom Right */}
            <path d="M96 130 Q100 135 96 140 Q92 145 85 144" fill="none" stroke={strokeColor} strokeWidth="0.8" />
            <path d="M92 144 Q96 140 92 136" fill="none" stroke={strokeColor} strokeWidth="0.5" />
            <circle cx="90" cy="140" r="1.5" fill={fillColor} />
            
            {/* Side decorations */}
            <path d="M4 50 Q0 55 4 60 Q8 55 4 50" fill={fillColor} opacity="0.4" />
            <path d="M4 90 Q0 95 4 100 Q8 95 4 90" fill={fillColor} opacity="0.4" />
            <path d="M96 50 Q100 55 96 60 Q92 55 96 50" fill={fillColor} opacity="0.4" />
            <path d="M96 90 Q100 95 96 100 Q92 95 96 90" fill={fillColor} opacity="0.4" />
          </svg>
        );
        ...
        return (
          <svg style={svgStyle} viewBox="0 0 100 150" preserveAspectRatio="none">
            ...
            <path 
              ...
              strokeWidth="1.2"
            />
            <path d="M8 8 Q12 12 8 16 Q4 12 8 8" fill={fillColor} opacity="0.5" />
            <circle cx="12" cy="12" r="2" fill="none" stroke={strokeColor} strokeWidth="0.6" />
            ...
            <path 
              ...
              strokeWidth="1.2"
            />
            <path d="M92 8 Q88 12 92 16 Q96 12 92 8" fill={fillColor} opacity="0.5" />
            <circle cx="88" cy="12" r="2" fill="none" stroke={strokeColor} strokeWidth="0.6" />
            ...
            <path 
              ...
              strokeWidth="1.2"
            />
            <path d="M8 142 Q12 138 8 134 Q4 138 8 142" fill={fillColor} opacity="0.5" />
            <circle cx="12" cy="138" r="2" fill="none" stroke={strokeColor} strokeWidth="0.6" />
            ...
            <path 
              ...
              strokeWidth="1.2"
            />
            <path d="M92 142 Q88 138 92 134 Q96 138 92 142" fill={fillColor} opacity="0.5" />
            <circle cx="88" cy="138" r="2" fill="none" stroke={strokeColor} strokeWidth="0.6" />
            
            {/* Side scrolls */}
            <path d="M3 60 Q7 65 3 70 Q-1 75 3 80" fill="none" stroke={strokeColor} strokeWidth="0.8" />
            <path d="M97 60 Q93 65 97 70 Q101 75 97 80" fill="none" stroke={strokeColor} strokeWidth="0.8" />
          </svg>
        );
