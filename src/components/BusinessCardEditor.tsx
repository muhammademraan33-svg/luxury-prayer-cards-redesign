...
export const BusinessCardEditor = () => {
  // Start directly with a default card (no celebration selector step)
  const [cardData, setCardData] = useState<BusinessCardData>(() => createDefaultCardData('wedding'));
  ...
  const handleCategoryChange = (category: CardCategory) => {
    setCardData(createDefaultCardData(category));
    setSelectedId(null);
    setSelectedType(null);
    setSidebarOpen(false);
    toast.success(`Switched to ${categoryInfo[category].name} template`);
  };
